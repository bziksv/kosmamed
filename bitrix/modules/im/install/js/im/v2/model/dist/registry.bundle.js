...
(function (exports,main_core_events,im_v2_lib_layout,im_v2_lib_user,im_v2_lib_userStatus,im_v2_lib_logger,im_v2_lib_recent,im_v2_lib_message,im_v2_lib_utils,im_v2_application_core,ui_vue3_vuex,im_v2_model,im_v2_const,main_core) {
	  ...
	  getGetters() {
	    return {
	      ...
	      getBlocks: state => messageId => {
	        var _state$blockCollectio;
	        return (_state$blockCollectio = state.blockCollection.get(messageId)) != null ? _state$blockCollectio : [];
	      }
	    };
	  }
	  getActions() {
	    return {
	      ...
	      set: (store, rawMessages) => {
	        ...
	        builderMessages.forEach(builderMessage => {
	          ...
	          const preparedBuilder = babelHelpers.classPrivateFieldLooseBase(this, _formatFields$1)[_formatFields$1](builder);
	          const {
	            blocks
	          } = preparedBuilder;
	...
	function _formatFields2$1(item) {
	    ...
	    return {
	      ...
	      setChatCollection: (store, payload) => {
	        ...
	        messages = messages.map(message => {
	          return {
	            ...this.getElementState(),
	            ...babelHelpers.classPrivateFieldLooseBase(this, _formatFields$2)[_formatFields$2](message)
	          };
	        });
	      ...
	      add: (store, payload) => {
	        const message = {
	          ...this.getElementState(),
	          ...babelHelpers.classPrivateFieldLooseBase(this, _formatFields$2)[_formatFields$2](payload)
	        };
	        store.commit('store', {
	          messages: [message]
	        });
	      ...
	      update: (store, payload) => {
	        ...
	        store.commit('update', {
	          ...
	          fields: {
	            ...currentMessage,
	            ...babelHelpers.classPrivateFieldLooseBase(this, _formatFields$2)[_formatFields$2](fields)
	          }
	        });
	      },
	      ...
	      deleteAttach: (store, payload) => {
	        ...
	        store.commit('update', {
	          ...
	          fields: {
	            ...message,
	            ...babelHelpers.classPrivateFieldLooseBase(this, _formatFields$2)[_formatFields$2]({
	              attach
	            })
	          }
	        });
	      ...
	      addLoadingMessage: (store, payload) => {
	        const message = {
	          ...this.getElementState(),
	          ...babelHelpers.classPrivateFieldLooseBase(this, _formatFields$2)[_formatFields$2](payload.message)
	        };
	        store.commit('store', {
	          messages: [message]
	        });
	    ...
	    return {
	      ...
	      set: (store, rawPayload) => {
	        ...
	        payload.forEach(element => {
	          const formattedElement = babelHelpers.classPrivateFieldLooseBase(this, _formatFields$3)[_formatFields$3](element);
	          const {
	            delay
	          } = formattedElement;
	  ...
	  getActions() {
	    return {
	      ...
	      set: (store, payload) => {
	        ...
	        store.commit('set', {
	          chatId,
	          collabInfo: babelHelpers.classPrivateFieldLooseBase(this, _formatFields$4)[_formatFields$4](collabInfo)
	        });
	      },
	...
	function _formatFields2$4(fields) {
	    ...
	    return {
	      ...
	      set: (store, payload) => {
	        ...
	        for (const rawElement of payload) {
	          const element = babelHelpers.classPrivateFieldLooseBase(this, _formatFields$5)[_formatFields$5](rawElement);
	          const existingItem = store.state.collection[element.dialogId];
	          if (existingItem) {
	            itemsToUpdate.push({
	      ...
	      update: (store, payload) => {
	        ...
	        store.commit('update', {
	          dialogId,
	          fields: babelHelpers.classPrivateFieldLooseBase(this, _formatFields$5)[_formatFields$5](fields)
	        });
	      },
	      /** @function recent/pin */
	      pin: (store, payload) => {
	  ...
	  getMutations() {
	    return {
	      ...
	      clearByDialogId: (state, payload) => {
	        var _index$parentChatId2, _index$parentChatId2$;
	        const {
	          parentChatId,
	          type,
	          dialogId,
	        ...
	        const index = unread ? state.unreadIndex : state.recentIndex;
	        (_index$parentChatId2 = index[parentChatId]) == null ? void 0 : (_index$parentChatId2$ = _index$parentChatId2[type]) == null ? void 0 : _index$parentChatId2$.delete(dialogId);
	      },
	      add: (state, payload) => {
	        if (!main_core.Type.isArray(payload) && main_core.Type.isPlainObject(payload)) {
	          payload = [payload];
	...
	function _formatFields2$5(rawFields) {
	...
	function _prepareFakeItemWithDraft2(payload) {
	  ...
	  return babelHelpers.classPrivateFieldLooseBase(this, _formatFields$5)[_formatFields$5]({
	...
	var _matchesRecentType = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("matchesRecentType");
	var _hasRecentType = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("hasRecentType");
	var _hasParentRecentType = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("hasParentRecentType");
	var _isMuted = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("isMuted");
	var _isParentMuted = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("isParentMuted");
	...
	class CountersModel extends ui_vue3_vuex.BuilderModel {
	  constructor(...args) {
	    ...
	    Object.defineProperty(this, _isParentMuted, {
	      value: _isParentMuted2
	    });
	    Object.defineProperty(this, _isMuted, {
	      value: _isMuted2
	    });
	    Object.defineProperty(this, _hasParentRecentType, {
	      value: _hasParentRecentType2
	    });
	    Object.defineProperty(this, _hasRecentType, {
	      value: _hasRecentType2
	    });
	    Object.defineProperty(this, _matchesRecentType, {
	      value: _matchesRecentType2
	    });
	  }
	  getName() {
	    return 'counters';
	    ...
	    return {
	      ...
	      getCounterByRecentType: state => recentType => {
	        ...
	        for (const counterItem of Object.values(collection)) {
	          if (!babelHelpers.classPrivateFieldLooseBase(this, _matchesRecentType)[_matchesRecentType](collection, counterItem, recentType)) {
	            continue;
	          }
	          if (babelHelpers.classPrivateFieldLooseBase(this, _isMuted)[_isMuted](counterItem) || babelHelpers.classPrivateFieldLooseBase(this, _isParentMuted)[_isParentMuted](state.collection, counterItem)) {
	            continue;
	          }
	      ...
	      getChildrenTotalCounter: state => (parentChatId, recentType) => {
	        ...
	        for (const counterItem of Object.values(state.collection)) {
	          if (recentType && !babelHelpers.classPrivateFieldLooseBase(this, _hasRecentType)[_hasRecentType](counterItem, recentType)) {
	            continue;
	          }
	          ...
	          if (babelHelpers.classPrivateFieldLooseBase(this, _isMuted)[_isMuted](counterItem)) {
	            continue;
	          }
	          totalCount += babelHelpers.classPrivateFieldLooseBase(this, _resolveCounter)[_resolveCounter](counterItem);
	        }
	    ...
	    return {
	      ...
	      setCounters: (store, payload) => {
	        ...
	        const preparedItems = payload.map(counterItem => {
	          const preparedItem = babelHelpers.classPrivateFieldLooseBase(this, _formatFields$6)[_formatFields$6](counterItem);
	...
	function _matchesRecentType2(collection, counterItem, recentType) {
	  return babelHelpers.classPrivateFieldLooseBase(this, _hasRecentType)[_hasRecentType](counterItem, recentType) || babelHelpers.classPrivateFieldLooseBase(this, _hasParentRecentType)[_hasParentRecentType](collection, counterItem, recentType);
	}
	function _hasRecentType2(counterItem, recentType) {
	  return counterItem.recentSections.includes(recentType);
	}
	function _hasParentRecentType2(collection, counterItem, recentType) {
	...
	function _isMuted2(counterItem) {
	  return counterItem.isMuted;
	}
	function _isParentMuted2(collection, counterItem) {
	...
	function _formatFields2$6(counterItem) {
	    ...
	    return {
	      ...
	      set: (store, payload) => {
	        payload.forEach(sticker => {
	          const preparedRecentSticker = babelHelpers.classPrivateFieldLooseBase(this, _formatFields$7)[_formatFields$7](sticker);
	          store.commit('add', {
	            ...this.getElementState(),
	      ...
	      update: (store, payload) => {
	        const preparedRecentSticker = babelHelpers.classPrivateFieldLooseBase(this, _formatFields$7)[_formatFields$7](payload);
	        store.commit('update', {
	          ...this.getElementState(),
	          ...preparedRecentSticker
	        });
	...
	function _formatFields2$7(sticker) {
	...
	class StickerMessagesModel extends ui_vue3_vuex.BuilderModel {
	  ...
	  getActions() {
	    return {
	      ...
	      set: (store, payload) => {
	        payload.forEach(message => {
	          const preparedStickerMessage = babelHelpers.classPrivateFieldLooseBase(this, _formatFields$8)[_formatFields$8](message);
	          store.commit('add', {
	            ...this.getElementState(),
	...
	function _formatFields2$8(stickerMessage) {
	    ...
	    return {
	      ...
	      set: (store, payload) => {
	        payload.forEach(pack => {
	          const preparedPack = babelHelpers.classPrivateFieldLooseBase(this, _formatFields$9)[_formatFields$9](pack);
	...
	function _formatFields2$9(pack) {
	...
	var _formatFields$a = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("formatFields");
	...
	class StickersModel extends ui_vue3_vuex.BuilderModel {
	  constructor(...args) {
	    ...
	    Object.defineProperty(this, _formatFields$a, {
	      value: _formatFields2$a
	    });
	  }
	  getName() {
	    return 'stickers';
	  ...
	  getActions() {
	    return {
	      ...
	      set: (store, payload) => {
	        payload.forEach(sticker => {
	          const preparedSticker = babelHelpers.classPrivateFieldLooseBase(this, _formatFields$a)[_formatFields$a](sticker);
	...
	function _formatFields2$a(rawSticker) {
