...
(function (exports,main_core,main_core_events,im_v2_application_core,im_v2_const,im_v2_lib_access,im_v2_lib_analytics,im_v2_lib_bulkActions,im_v2_lib_channel,im_v2_lib_feature,im_v2_lib_localStorage,im_v2_lib_logger) {
	...
	var _canSaveLastOpenedElement = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("canSaveLastOpenedElement");
	var _getChat = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("getChat");
	var _isNestedChat = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("isNestedChat");
	class LayoutManager {
	  constructor() {
	    Object.defineProperty(this, _isNestedChat, {
	      value: _isNestedChat2
	    });
	    Object.defineProperty(this, _getChat, {
	      value: _getChat2
	    });
	    Object.defineProperty(this, _canSaveLastOpenedElement, {
	      value: _canSaveLastOpenedElement2
	    });
	  ...
	  setLastOpenedElement(layoutName, entityId) {
	    if (!babelHelpers.classPrivateFieldLooseBase(this, _canSaveLastOpenedElement)[_canSaveLastOpenedElement](layoutName, entityId)) {
	      return;
	    }
	...
	function _canSaveLastOpenedElement2(layoutName, entityId) {
	  if (LayoutsWithoutLastOpenedElement.has(layoutName)) {
	    return false;
	  }
	  const {
	    type
	  } = babelHelpers.classPrivateFieldLooseBase(this, _getChat)[_getChat](entityId);
	  ...
	  return !babelHelpers.classPrivateFieldLooseBase(this, _isNestedChat)[_isNestedChat](layoutName, entityId);
	}
	function _getChat2(dialogId) {
	  return im_v2_application_core.Core.getStore().getters['chats/get'](dialogId, true);
	}
	function _isNestedChat2(layoutName, entityId) {
