...
(function (exports,main_core,main_core_events,im_v2_lib_logger,im_v2_application_core,im_v2_const,ui_dexie,im_v2_lib_localStorage) {
	...
	var _canUseFakeItems = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("canUseFakeItems");
	class DraftManager {
	  static getInstance() {
	  ...
	  constructor() {
	    Object.defineProperty(this, _canUseFakeItems, {
	      value: _canUseFakeItems2
	    });
	...
	function _setRecentItemDraftText2(dialogId, text) {
	  ...
	  void im_v2_application_core.Core.getStore().dispatch('recent/setDraft', {
	    dialogId,
	    text,
	    addFakeItems: babelHelpers.classPrivateFieldLooseBase(this, _canUseFakeItems)[_canUseFakeItems](dialogId)
	  });
	}
	...
	function _canUseFakeItems2(dialogId) {
	  const {
	    type: chatType,
	    parentChatId
