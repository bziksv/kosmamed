...
(function (exports,ui_notification,im_public,im_v2_application_core,im_v2_const,im_v2_provider_service_settings,main_core) {
	...
	const ChatNotifier = {
	  ...
	  handleCreateError(error) {
	    ...
	    const notificationText = (_NotificationTextByEr3 = NotificationTextByErrorCode[errorCode]) != null ? _NotificationTextByEr3 : NotificationTextByErrorCode.default;
	    showNotification(notificationText);
	  },
	  onUpdateError() {
	  ...
	  handleUserAddComplete(chatType) {
	    ...
	    const notificationText = (_NotificationTextByCh = NotificationTextByChatType[chatType]) != null ? _NotificationTextByCh : NotificationTextByChatType.default;
	    showNotification(notificationText);
	  },
	  handleUserAddError(chatType) {
	    var _NotificationTextByCh2;
	    const NotificationTextByChatType = {
	    ...
	    const notificationText = (_NotificationTextByCh2 = NotificationTextByChatType[chatType]) != null ? _NotificationTextByCh2 : NotificationTextByChatType.default;
	    showNotification(notificationText);
	  },
	  onCopyIdComplete() {
