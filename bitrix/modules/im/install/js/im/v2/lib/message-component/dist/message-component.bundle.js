...
(function (exports,im_v2_lib_utils,im_v2_application_core,im_v2_const,im_v2_lib_smileManager,imopenlines_v2_lib_openlines) {
	...
	var _hasBuilderBlocks = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("hasBuilderBlocks");
	...
	class MessageComponentManager {
	  constructor(message) {
	    ...
	    Object.defineProperty(this, _hasBuilderBlocks, {
	      value: _hasBuilderBlocks2
	    });
	  ...
	  getName() {
	    ...
	    if (babelHelpers.classPrivateFieldLooseBase(this, _hasBuilderBlocks)[_hasBuilderBlocks]()) {
	...
	function _hasBuilderBlocks2() {
	  return babelHelpers.classPrivateFieldLooseBase(this, _store)[_store].getters['messages/builder/hasBlocks'](babelHelpers.classPrivateFieldLooseBase(this, _message)[_message].id);
	}
	...
	function _isEmptyMessage2() {
	  return !babelHelpers.classPrivateFieldLooseBase(this, _hasText)[_hasText]() && !babelHelpers.classPrivateFieldLooseBase(this, _hasFiles)[_hasFiles]() && !babelHelpers.classPrivateFieldLooseBase(this, _hasAttach)[_hasAttach]() && !babelHelpers.classPrivateFieldLooseBase(this, _hasSticker)[_hasSticker]() && !babelHelpers.classPrivateFieldLooseBase(this, _hasBuilderBlocks)[_hasBuilderBlocks]();
	}
