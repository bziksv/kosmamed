...
(function (exports,main_core_events,im_v2_application_core,im_v2_lib_layout,im_v2_const) {
	...
	class CreateChatManager extends main_core_events.EventEmitter {
	  ...
	  startChatCreation(chatTypeToCreate, params = {}) {
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _includeCurrentUser)[_includeCurrentUser] = includeCurrentUser;
	  ...
	  getParentChatId() {
	    return babelHelpers.classPrivateFieldLooseBase(this, _parentChatId)[_parentChatId];
	  }
	  setChatType(type) {
	  ...
	  clearPresetFields() {
	    babelHelpers.classPrivateFieldLooseBase(this, _ownerId)[_ownerId] = null;
	    babelHelpers.classPrivateFieldLooseBase(this, _includeCurrentUser)[_includeCurrentUser] = true;
	    babelHelpers.classPrivateFieldLooseBase(this, _preselectedMembers)[_preselectedMembers] = [];
	  }
	}
