...
(function (exports,main_core,im_v2_lib_analytics,im_v2_lib_messageComponent,ui_analytics,im_v2_application_core,im_v2_const) {
	...
	var _sendData$1 = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("sendData");
	class RecentHeaderMenu {
	  constructor() {
	    Object.defineProperty(this, _sendData$1, {
	      value: _sendData2$1
	    });
	  }
	  onOpenUnreadMode() {
	    babelHelpers.classPrivateFieldLooseBase(this, _sendData$1)[_sendData$1](im_v2_const.ChatType.chat, AnalyticsEvent.openUnreadMode);
	  }
	  onReadAllChats() {
	    babelHelpers.classPrivateFieldLooseBase(this, _sendData$1)[_sendData$1](im_v2_const.ChatType.chat, AnalyticsEvent.readAllChats);
	  }
	  onOpenTasksUnreadMode() {
	    babelHelpers.classPrivateFieldLooseBase(this, _sendData$1)[_sendData$1](im_v2_const.ChatType.tasks, AnalyticsEvent.openUnreadMode);
	  }
	  onReadAllTaskChats() {
	    babelHelpers.classPrivateFieldLooseBase(this, _sendData$1)[_sendData$1](im_v2_const.ChatType.tasks, AnalyticsEvent.readAllChats);
	  }
	}
	function _sendData2$1(type, event) {
	  const currentLayout = im_v2_application_core.Core.getStore().getters['application/getLayout'].name;
	  ui_analytics.sendData({
	    tool: AnalyticsTool.im,
	    category: AnalyticsCategory.messenger,
	...
	class Analytics {
	  constructor() {
	    ...
	    this.recentHeaderMenu = new RecentHeaderMenu();
	  }
	  static getInstance() {
