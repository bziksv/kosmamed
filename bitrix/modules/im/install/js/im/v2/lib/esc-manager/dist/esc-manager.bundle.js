...
(function (exports,main_core,main_core_events,main_popup,main_sidepanel,im_v2_lib_utils,im_v2_lib_call,im_v2_application_core,im_v2_const,im_v2_lib_layout,im_v2_lib_slider,im_v2_lib_desktop,im_v2_lib_desktopApi) {
	...
	var _handleAdditionalRecentLists = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("handleAdditionalRecentLists");
	class EscManager {
	  constructor() {
	    Object.defineProperty(this, _handleAdditionalRecentLists, {
	      value: _handleAdditionalRecentLists2
	    });
	  ...
	  async handleEsc() {
	    ...
	    if (await babelHelpers.classPrivateFieldLooseBase(this, _handleAdditionalRecentLists)[_handleAdditionalRecentLists]()) {
	      return;
	    }
	...
	async function _handleAdditionalRecentLists2() {
