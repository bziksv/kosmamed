...
(function (exports,im_v2_lib_user,im_v2_lib_copilot,im_v2_lib_analytics,im_v2_lib_messageBuilder,main_core_events,im_v2_lib_utils,im_v2_lib_permission,rest_client,im_v2_lib_notifier,ui_vue3_vuex,im_v2_application_core,im_v2_const,im_v2_lib_logger,im_v2_lib_rest) {
	'use strict';
	...
	function _updateModels2(rawData) {
	  ...
	  const builderPromise = babelHelpers.classPrivateFieldLooseBase(this, _store)[_store].dispatch('messages/builder/set', messages);
...
}((this.BX.Messenger.v2.Service = this.BX.Messenger.v2.Service || {}),BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX,BX.Event,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX,BX.Messenger.v2.Lib,BX.Vue3.Vuex,BX.Messenger.v2.Application,BX.Messenger.v2.Const,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib));
