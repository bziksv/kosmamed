...
(function (exports,im_v2_lib_layout,main_core,im_v2_application_core,im_v2_lib_copilot,im_v2_lib_logger,im_v2_lib_rest,im_v2_lib_user,im_v2_const) {
	'use strict';
	...
	var _unreadMode = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("unreadMode");
	var _parentChatId = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("parentChatId");
	...
	class BaseRecentService {
	  constructor(params = {}) {
	    ...
	    Object.defineProperty(this, _unreadMode, {
	      writable: true,
	      value: false
	    });
	    Object.defineProperty(this, _parentChatId, {
	      writable: true,
	      value: 0
	    });
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _unreadMode)[_unreadMode] = unreadMode;
	    babelHelpers.classPrivateFieldLooseBase(this, _parentChatId)[_parentChatId] = parentChatId;
	  }
	  loadFirstPage() {
	  ...
	  saveRecentItems(recentItems) {
	    const setPayload = {
	      ...
	      items: recentItems,
	      unread: babelHelpers.classPrivateFieldLooseBase(this, _unreadMode)[_unreadMode]
	    };
	    if (babelHelpers.classPrivateFieldLooseBase(this, _parentChatId)[_parentChatId] !== null) {
	      setPayload.parentChatId = babelHelpers.classPrivateFieldLooseBase(this, _parentChatId)[_parentChatId];
	    }
	  ...
	  getRequestFilter(firstPage = false) {
	    return {
	      ...
	      parentId: babelHelpers.classPrivateFieldLooseBase(this, _parentChatId)[_parentChatId],
	      unread: babelHelpers.classPrivateFieldLooseBase(this, _unreadMode)[_unreadMode]
	    };
	  }
...
}((this.BX.Messenger.v2.Service = this.BX.Messenger.v2.Service || {}),BX.Messenger.v2.Lib,BX,BX.Messenger.v2.Application,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Const));
