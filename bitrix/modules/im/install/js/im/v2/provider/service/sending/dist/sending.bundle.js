...
(function (exports,main_core,main_core_events,im_v2_application_core,im_v2_const,im_v2_lib_logger,im_v2_lib_rest,im_v2_lib_utils,im_v2_provider_service_message) {
	...
	var _prepareCustomFields = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("prepareCustomFields");
	...
	class SendingService {
	  ...
	  constructor() {
	    ...
	    Object.defineProperty(this, _prepareCustomFields, {
	      value: _prepareCustomFields2
	    });
	...
	function _prepareCustomFields2(dialogId, temporaryId) {
	...
	function _prepareMessage2(params) {
	  ...
	  const customFields = babelHelpers.classPrivateFieldLooseBase(this, _prepareCustomFields)[_prepareCustomFields](dialogId, tempMessageId);
	  return {
	    text,
	    dialogId,
