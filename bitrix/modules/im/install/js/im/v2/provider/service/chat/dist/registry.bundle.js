...
(function (exports,call_lib_callTokenManager,im_public,im_v2_provider_service_message,im_v2_lib_copilot,im_v2_lib_messageBuilder,im_v2_lib_user,im_v2_lib_analytics,ui_uploader_core,im_v2_lib_roleManager,im_v2_lib_uuid,im_v2_lib_counter,ui_vue3_vuex,rest_client,im_v2_lib_utils,im_v2_lib_notifier,im_v2_lib_layout,main_core,im_v2_application_core,im_v2_lib_logger,im_v2_const,im_v2_lib_rest,im_v2_lib_feature) {
	...
	async function _updateModels2$1(restResult) {
	  ...
	  const builderPromise = babelHelpers.classPrivateFieldLooseBase(this, _store$1)[_store$1].dispatch('messages/builder/set', extractor.getMessages());
	...
	function _addChatToModel2(newDialogId, chatConfig) {
	  ...
	  void im_v2_application_core.Core.getStore().dispatch('chats/set', {
	    ...
	    parentChatId: (_chatConfig$parentCha = chatConfig.parentChatId) != null ? _chatConfig$parentCha : 0,
	    permissions: {
	...
	class RenameService {
	  ...
	  renameChat(dialogId, newName) {
	    ...
	    return babelHelpers.classPrivateFieldLooseBase(this, _restClient)[_restClient].callMethod(im_v2_const.RestMethod.imChatUpdateTitle, {
	      dialog_id: dialogId,
	      title: newName
	    }).catch(result => {
	...
	class MuteService {
	  ...
	  muteChat(dialogId) {
	    ...
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$3)[_store$3].dispatch('chats/mute', {
	      dialogId
	    });
	    const queryParams = {
	      dialog_id: dialogId,
	  ...
	  unmuteChat(dialogId) {
	    ...
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$3)[_store$3].dispatch('chats/unmute', {
	      dialogId
	    });
	    const queryParams = {
	      dialog_id: dialogId,
	...
	function _sendMuteRequest2(queryParams) {
	  ...
	  return babelHelpers.classPrivateFieldLooseBase(this, _restClient$1)[_restClient$1].callMethod(im_v2_const.RestMethod.imChatMute, queryParams).catch(result => {
	    ...
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$3)[_store$3].dispatch(actionType, {
	      dialogId
	    });
	  });
	}
	...
	class PinService {
	  ...
	  pinChat(dialogId) {
	    ...
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$4)[_store$4].dispatch('recent/pin', {
	      dialogId,
	      action: true
	    });
	...
	class ReadService {
	  ...
	  readDialog(dialogId) {
	    ...
	    const {
	      chatId
	    } = babelHelpers.classPrivateFieldLooseBase(this, _store$5)[_store$5].getters['chats/get'](dialogId);
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$5)[_store$5].dispatch('counters/clearById', {
	      chatId
	    });
	    babelHelpers.classPrivateFieldLooseBase(this, _restClient$2)[_restClient$2].callMethod(im_v2_const.RestMethod.imV2ChatRead, {
	      dialogId
	    }).catch(result => {
	  ...
	  unreadDialog(dialogId) {
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _restClient$2)[_restClient$2].callMethod(im_v2_const.RestMethod.imV2ChatUnread, {
	      dialogId
	    }).catch(result => {
	  ...
	  clearDialogMark(dialogId) {
	    ...
	    const unreadStatus = babelHelpers.classPrivateFieldLooseBase(this, _store$5)[_store$5].getters['counters/getUnreadStatus'](chatId);
	    if (markedId === 0 && !unreadStatus) {
	      return;
	    }
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$5)[_store$5].dispatch('counters/setUnreadStatus', {
	      chatId,
	      status: false
	    });
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$5)[_store$5].dispatch('chats/update', {
	      dialogId,
	      fields: {
	        markedId: 0
	      }
	...
	function _decreaseChatCounter2(chatId, readMessagesCount) {
	  const currentCounter = babelHelpers.classPrivateFieldLooseBase(this, _store$5)[_store$5].getters['counters/getCounterByChatId'](chatId);
	  ...
	  return babelHelpers.classPrivateFieldLooseBase(this, _store$5)[_store$5].dispatch('counters/setCounter', {
	    chatId,
	    counter: newCounter
	  });
	}
	...
	function _checkChatCounter2(readResult) {
	  ...
	  if (currentCounter > counter) {
	    ...
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$5)[_store$5].dispatch('counters/setCounter', {
	      chatId,
	      counter
	    });
	  }
	...
	class UserService {
	  ...
	  async leaveChat(dialogId) {
	    ...
	    try {
	      await babelHelpers.classPrivateFieldLooseBase(this, _restClient$3)[_restClient$3].callMethod(im_v2_const.RestMethod.imV2ChatDeleteUser, queryParams);
	  ...
	  async kickUserFromChat(dialogId, userId) {
	    ...
	    await babelHelpers.classPrivateFieldLooseBase(this, _restClient$3)[_restClient$3].callMethod(im_v2_const.RestMethod.imV2ChatDeleteUser, queryParams).catch(result => {
	  ...
	  addToChat(addConfig) {
	    ...
	    return babelHelpers.classPrivateFieldLooseBase(this, _restClient$3)[_restClient$3].callMethod(im_v2_const.RestMethod.imChatUserAdd, queryParams).catch(result => {
	  ...
	  joinChat(dialogId) {
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _restClient$3)[_restClient$3].callMethod(im_v2_const.RestMethod.imV2ChatJoin, {
	      dialogId
	    }).catch(result => {
	...
	function _onChatLeave2(dialogId) {
	  ...
	  void babelHelpers.classPrivateFieldLooseBase(this, _store$6)[_store$6].dispatch('recent/hide', {
	    dialogId
	  });
	...
	class MessagesAutoDeleteService {
	  ...
	  setDelay(dialogId, delay) {
	    ...
	    const previousDelay = babelHelpers.classPrivateFieldLooseBase(this, _store$7)[_store$7].getters['chats/autoDelete/getDelay'](chatId);
	    if (previousDelay === delay) {
	      return;
	    }
	    void babelHelpers.classPrivateFieldLooseBase(this, _store$7)[_store$7].dispatch('chats/autoDelete/set', {
	      chatId,
	      delay
	    });
	...
	function _getChatId2(dialogId) {
	  return babelHelpers.classPrivateFieldLooseBase(this, _store$7)[_store$7].getters['chats/get'](dialogId).chatId;
	}
...
}((this.BX.Messenger.v2.Service = this.BX.Messenger.v2.Service || {}),BX?.Call?.Lib??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Service??{},BX?.Messenger?.v2?.Lib??{},BX??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Lib??{},BX?.UI?.Uploader??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Lib??{},BX?.Vue3?.Vuex??{},BX??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Lib??{},BX??{},BX?.Messenger?.v2?.Application??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Const??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Lib??{}));
