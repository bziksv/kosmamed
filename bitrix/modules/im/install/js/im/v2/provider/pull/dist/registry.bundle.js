...
(function (exports,im_v2_provider_service_message,im_v2_lib_channel,main_core_events,ui_vue3_vuex,im_v2_lib_inputAction,im_v2_lib_roleManager,im_v2_lib_analytics,im_v2_lib_notifier,main_sidepanel,im_public,im_v2_lib_slider,im_v2_lib_layout,im_v2_lib_copilot,im_v2_lib_utils,im_v2_lib_unreadMode,im_v2_lib_user,im_v2_const,im_v2_lib_messageNotifier,im_v2_lib_desktop,im_v2_lib_call,im_v2_lib_localStorage,main_core,im_v2_lib_counter,im_v2_lib_logger,im_v2_lib_uuid,im_v2_lib_promo,im_v2_application_core) {
	...
	var _setBuilder = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("setBuilder");
	...
	class MessagePullHandler {
	  constructor() {
	    ...
	    Object.defineProperty(this, _setBuilder, {
	      value: _setBuilder2
	    });
	  ...
	  handleMessageAdd(params) {
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _setBuilder)[_setBuilder](params.message);
	  ...
	  handleMessageUpdate(params) {
	    ...
	    babelHelpers.classPrivateFieldLooseBase(this, _setBuilder)[_setBuilder](params);
	    babelHelpers.classPrivateFieldLooseBase(this, _sendScrollEvent)[_sendScrollEvent](params.chatId);
	  }
	...
	function _setAdditionalEntities2(params) {
	  ...
	  babelHelpers.classPrivateFieldLooseBase(this, _setBuilder)[_setBuilder](newMessages);
	}
	...
	function _setBuilder2(payload) {
	  const messages = main_core.Type.isArray(payload) ? payload : [payload];
	  void babelHelpers.classPrivateFieldLooseBase(this, _store$2)[_store$2].dispatch('messages/builder/set', messages);
	}
	...
	var _getParentChatId = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("getParentChatId");
	...
	class RecentUpdateManager {
	  constructor(params) {
	    ...
	    Object.defineProperty(this, _getParentChatId, {
	      value: _getParentChatId2
	    });
	  ...
	  applyRecentUpdateActions(sections, recentItem) {
	    sections.forEach(recentSection => {
	      void im_v2_application_core.Core.getStore().dispatch('recent/setCollection', {
	        type: recentSection,
	        items: [recentItem],
	        parentChatId: babelHelpers.classPrivateFieldLooseBase(this, _getParentChatId)[_getParentChatId]()
	      });
	    });
	  }
	}
	...
	function _getParentChatId2() {
	  return babelHelpers.classPrivateFieldLooseBase(this, _params$1)[_params$1].chat.parent_chat_id;
	}
	...
	function _setMessage2() {
	  if (babelHelpers.classPrivateFieldLooseBase(this, _params$1)[_params$1].message) {
	    void im_v2_application_core.Core.getStore().dispatch('messages/setChatCollection', {
	      messages: babelHelpers.classPrivateFieldLooseBase(this, _params$1)[_params$1].message
	    });
	    return;
	  }
	...
	var _isChatOpen = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("isChatOpen");
	var _hasChatCounters = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("hasChatCounters");
	var _hasParentChatCounters = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("hasParentChatCounters");
	class RecentUnreadPullHandler {
	  constructor() {
	    Object.defineProperty(this, _hasParentChatCounters, {
	      value: _hasParentChatCounters2
	    });
	    Object.defineProperty(this, _hasChatCounters, {
	      value: _hasChatCounters2
	    });
	    Object.defineProperty(this, _isChatOpen, {
	      value: _isChatOpen2
	    });
	  ...
	  handleReadMessageChat(params) {
	    ...
	    if (babelHelpers.classPrivateFieldLooseBase(this, _isChatOpen)[_isChatOpen](dialogId)) {
	      return;
	    }
	    if (babelHelpers.classPrivateFieldLooseBase(this, _hasChatCounters)[_hasChatCounters](chatId, counter, unread)) {
	      return;
	    }
	    if (!parentChatId) {
	    ...
	    if (babelHelpers.classPrivateFieldLooseBase(this, _isChatOpen)[_isChatOpen](parentDialogId)) {
	      return;
	    }
	    if (babelHelpers.classPrivateFieldLooseBase(this, _hasParentChatCounters)[_hasParentChatCounters](parentChatId)) {
	      return;
	    }
	  ...
	  handleChatUnread(params) {
	    ...
	    if (babelHelpers.classPrivateFieldLooseBase(this, _isChatOpen)[_isChatOpen](dialogId) || muted) {
	      return;
	    }
	    if (active) {
	  ...
	  handleChatMuteNotify(params) {
	    ...
	    const isMutedClosedChat = muted && !babelHelpers.classPrivateFieldLooseBase(this, _isChatOpen)[_isChatOpen](dialogId);
	    if (isMutedClosedChat) {
	      im_v2_lib_unreadMode.UnreadModeManager.clearDialogIdBySections(recentConfig.sections, dialogId);
	      return;
	    }
	    if (muted || !babelHelpers.classPrivateFieldLooseBase(this, _hasChatCounters)[_hasChatCounters](chatId, counter, unread)) {
	      return;
	    }
	    const manager = new RecentUnreadUpdateManager(params);
	    manager.addToRecentCollection();
	...
	function _hasParentChatCounters2(parentChatId) {
...
}((this.BX.Messenger.v2.Provider.Pull = this.BX.Messenger.v2.Provider.Pull || {}),BX.Messenger.v2.Service,BX.Messenger.v2.Lib,BX.Event,BX.Vue3.Vuex,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.SidePanel,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Const,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Application));
