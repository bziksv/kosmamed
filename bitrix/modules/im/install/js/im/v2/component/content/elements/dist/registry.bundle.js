...
(function (exports,call_component_callButton,im_v2_component_elements_loader,im_v2_component_animation,ui_iconSet_api_vue,im_v2_component_elements_chatTitle,im_v2_component_elements_avatar,im_v2_lib_utils,main_core_events,ui_vue3,im_v2_component_dialog_chat,im_v2_component_textarea,im_v2_lib_textarea,im_v2_component_sidebar,ui_uploader_core,im_v2_provider_service_uploading,im_v2_provider_service_chat,ui_vue3_directives_hint,im_v2_lib_analytics,im_v2_lib_permission,im_v2_component_elements_button,im_v2_component_entitySelector,im_v2_lib_confirm,im_v2_provider_service_message,main_core,im_v2_application_core,im_v2_const,im_v2_lib_theme) {
	'use strict';
	...
	const EntityLink = {
	  ...
	  computed: {
	    ...
	    linkText() {
	      ...
	      return (_ParamsByLinkType$thi = (_ParamsByLinkType$thi2 = ParamsByLinkType[this.entityType]) == null ? void 0 : _ParamsByLinkType$thi2.loc) != null ? _ParamsByLinkType$thi : 'Open entity';
	    }
	  },
	  template: `
...
}((this.BX.Messenger.v2.Component.Content = this.BX.Messenger.v2.Component.Content || {}),BX?.Call?.Component??{},BX?.Messenger?.v2?.Component?.Elements??{},BX?.Messenger?.v2?.Component?.Animation??{},BX?.UI?.IconSet??{},BX?.Messenger?.v2?.Component?.Elements??{},BX?.Messenger?.v2?.Component?.Elements??{},BX?.Messenger?.v2?.Lib??{},BX?.Event??{},BX?.Vue3??{},BX?.Messenger?.v2?.Component?.Dialog??{},BX?.Messenger?.v2?.Component??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Component??{},BX?.UI?.Uploader??{},BX?.Messenger?.v2?.Service??{},BX?.Messenger?.v2?.Service??{},BX?.Vue3?.Directives??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Component?.Elements??{},BX?.Messenger?.v2?.Component?.EntitySelector??{},BX?.Messenger?.v2?.Lib??{},BX?.Messenger?.v2?.Service??{},BX??{},BX?.Messenger?.v2?.Application??{},BX?.Messenger?.v2?.Const??{},BX?.Messenger?.v2?.Lib??{}));
