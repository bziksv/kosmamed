...
(function (exports,im_v2_provider_service_chat,ui_entitySelector,im_v2_lib_channel,main_core_events,intranet_invitationInput,im_v2_application_core,im_v2_component_elements_scrollWithGradient,im_v2_lib_helpdesk,ui_infoHelper,im_v2_lib_utils,im_v2_lib_permission,im_v2_lib_feature,im_v2_component_elements_button,intranet_languages,main_core,ui_vue3_directives_hint,im_v2_provider_service_collabInvitation,main_popup,im_v2_component_elements_popup,im_v2_lib_soundNotification,im_v2_provider_service_sending,im_public,im_v2_const,im_v2_lib_analytics,im_v2_component_search,im_v2_lib_notifier) {
	'use strict';

	const SEARCH_ENTITY_ID = 'user';
	const DEFAULT_CONTAINER_HEIGHT = 600;
	const ShowHistoryTitleByChatType = {
	  [im_v2_const.ChatType.taskComments]: main_core.Loc.getMessage('IM_ENTITY_SELECTOR_ADD_TO_TASK_COMMENTS_SHOW_HISTORY'),
	  default: main_core.Loc.getMessage('IM_ENTITY_SELECTOR_ADD_TO_CHAT_SHOW_HISTORY')
	};
	...
	const AddToChatContent = {
	  ...
	  computed: {
	    ...
	    showHistoryTitle() {
	      var _ShowHistoryTitleByCh;
	      return (_ShowHistoryTitleByCh = ShowHistoryTitleByChatType[this.dialog.type]) != null ? _ShowHistoryTitleByCh : ShowHistoryTitleByChatType.default;
	    },
	    containerStyles() {
	      return {
...
}((this.BX.Messenger.v2.Component.EntitySelector = this.BX.Messenger.v2.Component.EntitySelector || {}),BX.Messenger.v2.Service,BX.UI.EntitySelector,BX.Messenger.v2.Lib,BX.Event,BX.Intranet,BX.Messenger.v2.Application,BX.Messenger.v2.Component.Elements,BX.Messenger.v2.Lib,BX.UI,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Component.Elements,BX.Intranet,BX,BX.Vue3.Directives,BX.Messenger.v2.Service,BX.Main,BX.Messenger.v2.Component.Elements,BX.Messenger.v2.Lib,BX.Messenger.v2.Service,BX.Messenger.v2.Lib,BX.Messenger.v2.Const,BX.Messenger.v2.Lib,BX.Messenger.v2.Component,BX.Messenger.v2.Lib));
