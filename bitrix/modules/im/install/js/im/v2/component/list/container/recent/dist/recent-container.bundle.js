...
(function (exports,main_core_events,im_v2_component_list_items_recent,im_v2_component_search,im_v2_lib_logger,im_v2_component_list_container_elements_headerMenu,ui_infoHelper,im_public,im_v2_component_elements_copilotRolesDialog,im_v2_component_elements_menu,im_v2_component_list_container_elements_createChatPromo,im_v2_lib_createChat,im_v2_lib_feature,im_v2_lib_permission,im_v2_provider_service_copilot,main_core,im_v2_lib_copilot,im_v2_lib_helpdesk,im_v2_lib_analytics,im_v2_lib_invite,im_v2_lib_promo,im_v2_const) {
	'use strict';
	...
	const CreateChatMenu = {
	  ...
	  methods: {
	    ...
	    startChatCreation() {
	      ...
	      void im_v2_lib_createChat.CreateChatManager.getInstance().startChatCreation(this.chatTypeToCreate);
	    },
	    getPromoType() {
...
}((this.BX.Messenger.v2.Component.List = this.BX.Messenger.v2.Component.List || {}),BX.Event,BX.Messenger.v2.Component.List,BX.Messenger.v2.Component,BX.Messenger.v2.Lib,BX.Messenger.v2.Component.List,BX.UI,BX.Messenger.v2.Lib,BX.Messenger.v2.Component.Elements,BX.Messenger.v2.Component.Elements,BX.Messenger.v2.Component.List,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Service,BX,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Const));
