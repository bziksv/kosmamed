...
(function (exports,ui_iconSet_outline,ui_uploader_core,im_v2_provider_service_message,im_v2_lib_soundNotification,im_v2_lib_inputAction,im_v2_lib_escManager,im_v2_lib_message,im_v2_lib_desktopApi,ui_system_chip_vue,im_v2_lib_localStorage,im_v2_component_elements_pulseAnimation,im_v2_lib_smileManager,im_v2_provider_service_sticker,main_polyfill_intersectionobserver,main_core_events,im_v2_provider_service_sending,im_v2_lib_directives,im_v2_component_sticker,im_v2_lib_sticker,im_v2_lib_promo,calendar_sharing_interface,vote_application,im_v2_component_elements_menu,im_v2_lib_entityCreator,file_dialog,im_v2_model,im_v2_lib_draft,im_v2_lib_hotkey,im_v2_provider_service_uploading,im_v2_component_elements_mediaGallery,im_v2_component_elements_sendButton,ui_icons,im_v2_lib_channel,im_v2_lib_copilot,im_v2_lib_user,im_v2_lib_logger,im_v2_lib_rest,im_v2_lib_search,im_v2_component_elements_scrollWithGradient,im_v2_component_elements_avatar,im_v2_component_elements_chatTitle,im_v2_lib_textHighlighter,im_v2_lib_permission,im_v2_lib_feature,ui_iconSet_api_core,im_v2_lib_menu,im_v2_lib_notifier,im_v2_provider_service_collabInvitation,im_public,im_v2_application_core,im_v2_lib_parser,ui_vue3_components_richLoc,im_v2_component_elements_loader,im_v2_lib_market,im_v2_component_elements_autoDelete,im_v2_provider_service_chat,im_v2_lib_autoDelete,im_v2_const,main_core,main_popup,im_v2_lib_textarea,im_v2_component_elements_popup,im_v2_lib_quote,im_v2_lib_analytics,ui_system_input_vue,ui_iconSet_api_vue,im_v2_lib_utils) {
	...
	const AddToChatTitleByChatType = {
	  [im_v2_const.ChatType.taskComments]: main_core.Loc.getMessage('IM_TEXTAREA_MENTION_ADD_TO_TASK_COMMENTS_DROPDOWN_MENU'),
	  default: main_core.Loc.getMessage('IM_TEXTAREA_MENTION_ADD_TO_CHAT_DROPDOWN_MENU')
	};
	var _getAddToChatItem = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("getAddToChatItem");
	var _insertMention = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("insertMention");
	...
	class AddToChatDropdownMenu extends im_v2_lib_menu.BaseMenu {
	  constructor(applicationContext) {
	    ...
	    Object.defineProperty(this, _insertMention, {
	      value: _insertMention2
	    });
	    Object.defineProperty(this, _getAddToChatItem, {
	      value: _getAddToChatItem2
	    });
	  ...
	  getMenuItems() {
	    return [babelHelpers.classPrivateFieldLooseBase(this, _getAddToChatItem)[_getAddToChatItem]()];
	  }
	}
	function _getAddToChatItem2() {
	  var _AddToChatTitleByChat;
	  return {
	    title: (_AddToChatTitleByChat = AddToChatTitleByChatType[babelHelpers.classPrivateFieldLooseBase(this, _getChatType)[_getChatType]()]) != null ? _AddToChatTitleByChat : AddToChatTitleByChatType.default,
	    icon: ui_iconSet_api_core.Outline.ADD_PERSON,
	    onClick: async () => {
	      try {
	        babelHelpers.classPrivateFieldLooseBase(this, _insertMention)[_insertMention]();
	        await babelHelpers.classPrivateFieldLooseBase(this, _handleAddToChat)[_handleAddToChat]();
	      } catch {
	        im_v2_lib_notifier.Notifier.chat.handleUserAddError(babelHelpers.classPrivateFieldLooseBase(this, _getChatType)[_getChatType]());
	      }
	    }
	  };
	}
	function _insertMention2() {
	  const params = {
	...
	async function _handleAddToChat2() {
	  ...
	  im_v2_lib_notifier.Notifier.chat.handleUserAddComplete(babelHelpers.classPrivateFieldLooseBase(this, _getChatType)[_getChatType]());
	}
	async function _createChatFromUser2() {
	  const {
	    newDialogId
	  } = await this.chatService.extendToGroupChat({
	    users: [this.context.dialogId, this.context.userId, im_v2_application_core.Core.getUserId()],
	...
	const DropdownTitleByChatType = {
	  [im_v2_const.ChatType.taskComments]: main_core.Loc.getMessage('IM_TEXTAREA_MENTION_ADD_TO_TASK_COMMENTS_DROPDOWN_TITLE'),
	  default: main_core.Loc.getMessage('IM_TEXTAREA_MENTION_ADD_TO_CHAT_DROPDOWN_TITLE')
	};
	...
	const AddToChatDropdown = {
	  ...
	  computed: {
	    ...
	    title() {
	      var _DropdownTitleByChatT;
	      return (_DropdownTitleByChatT = DropdownTitleByChatType[this.dialog.type]) != null ? _DropdownTitleByChatT : DropdownTitleByChatType.default;
	    }
	  },
	  methods: {
	    closeMenu() {
	...
	const MentionPopupContent = {
	  ...
	  methods: {
	    ...
	    isChat(dialogId) {
	      return dialogId.startsWith(im_v2_const.DialogIdChatPrefix);
	    },
