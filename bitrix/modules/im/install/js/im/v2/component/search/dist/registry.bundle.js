...
(function (exports,im_v2_component_elements_loader,im_v2_lib_menu,im_v2_provider_service_chat,im_v2_component_elements_avatar,im_v2_component_elements_chatTitle,im_v2_lib_dateFormatter,im_v2_lib_textHighlighter,im_v2_component_elements_searchInput,main_core,main_core_events,ui_designTokens,ui_fonts_opensans,im_v2_application_core,im_v2_component_elements_scrollWithGradient,im_v2_const,im_v2_lib_analytics,im_v2_lib_search,im_v2_lib_utils,im_v2_provider_service_search) {
	'use strict';
	...
	const ForwardSearch = {
	  ...
	  created() {
	    this.searchService = new im_v2_provider_service_search.SearchService(EntitySearchConfig[EntitySearchType.messageForward]);
	    this.searchOnServerDelayed = main_core.Runtime.debounce(this.searchOnServer, 400, this);
...
}((this.BX.Messenger.v2.Component = this.BX.Messenger.v2.Component || {}),BX.Messenger.v2.Component.Elements,BX.Messenger.v2.Lib,BX.Messenger.v2.Service,BX.Messenger.v2.Component.Elements,BX.Messenger.v2.Component.Elements,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Component.Elements,BX,BX.Event,BX,BX,BX.Messenger.v2.Application,BX.Messenger.v2.Component.Elements,BX.Messenger.v2.Const,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Lib,BX.Messenger.v2.Service));
