...
const ShowHistoryTitleByChatType = {
	[ChatType.taskComments]: Loc.getMessage('IM_ENTITY_SELECTOR_ADD_TO_TASK_COMMENTS_SHOW_HISTORY'),
	default: Loc.getMessage('IM_ENTITY_SELECTOR_ADD_TO_CHAT_SHOW_HISTORY'),
};
...
export const AddToChatContent = {
	...
	computed:
	{
		...
		showHistoryTitle(): string
		{
			return ShowHistoryTitleByChatType[this.dialog.type] ?? ShowHistoryTitleByChatType.default;
		},
