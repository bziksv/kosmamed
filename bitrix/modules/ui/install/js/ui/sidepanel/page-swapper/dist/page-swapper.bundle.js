...
(function (exports,main_core,main_core_events,ui_iconSet_api_core,ui_iconSet_actions,main_loader) {
	...
	function _setPrevButton2() {
	  ...
	  this.prevBtn = main_core.Tag.render(_t2 || (_t2 = _`<button type="button" class="ui-page-swap-btn ui-page-swap-left"></button>`));
	...
	function _setNextButton2() {
	  ...
	  this.nextBtn = main_core.Tag.render(_t3 || (_t3 = _`<button type="button" class="ui-page-swap-btn ui-page-swap-right"></button>`));
