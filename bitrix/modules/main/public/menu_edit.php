...
?>
	...
	<tr>
		...
		<td>
			...
			<div class="edit-area" id="edit_area_text_<?=$i?>" style="display: none;"><input type="text" class="menu-edit-input" name="text_<?echo $i?>" value="<?=htmlspecialcharsbx($aMenuLinksItem[0])?>" onblur="viewArea('text_<?=$i?>')" />
</div>
		</td>
		<td>
			...
			<div class="edit-area" id="edit_area_link_<?=$i?>" style="display: none;"><input type="text" class="menu-edit-input" name="link_<?echo $i?>" value="<?=htmlspecialcharsbx($aMenuLinksItem[1])?>" onblur="viewArea('link_<?=$i?>')" /></div>
		</td>
		<td>
<?
