...
<tr>
	...
	<td nowrap>
		...
		<select name="find_type">
			<option value="message"<?php if($find_type=="message") echo " selected"?>><?= Loc::getMessage("sms_template_admin_message")?></option>
			<option value="sender"<?php if($find_type=="sender") echo " selected"?>><?= Loc::getMessage("sms_template_admin_sender")?></option>
			<option value="receiver"<?php if($find_type=="receiver") echo " selected"?>><?= Loc::getMessage("sms_template_admin_receiver")?></option>
		</select>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="find_event_name" size="25" value="<?= htmlspecialcharsbx($find_event_name)?>"><br>
...
<tr>
	...
	<td><input type="text" name="find_sender" size="47" value="<?= htmlspecialcharsbx($find_sender)?>"></td>
</tr>
<tr>
	<td><?= $fields["RECEIVER"]->getTitle()?>:</td>
	<td><input type="text" name="find_receiver" size="47" value="<?= htmlspecialcharsbx($find_receiver)?>"></td>
</tr>
<tr>
	<td><?= $fields["MESSAGE"]->getTitle()?>:</td>
	<td><input type="text" name="find_message" size="47" value="<?= htmlspecialcharsbx($find_message)?>"></td>
</tr>
<?php
