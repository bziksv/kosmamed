		...
		<td colspan="2" align="center">
			<table border="0" cellspacing="10" cellpadding="2">
				...
				<tr>
					...
					<td align="center"><input type="text" name="EDIT_FORM_LABEL[<?= $htmlLID?>]" size="20" maxlength="255" value="<?= htmlspecialcharsbx($bVarsFromForm? ($_REQUEST["EDIT_FORM_LABEL"][$arLanguage["LID"]] ?? '') : ($arUserField["EDIT_FORM_LABEL"][$arLanguage["LID"]] ?? ''))?>"></td>
					<td align="center"><input type="text" name="LIST_COLUMN_LABEL[<?= $htmlLID?>]" size="20" maxlength="255" value="<?= htmlspecialcharsbx($bVarsFromForm? ($_REQUEST["LIST_COLUMN_LABEL"][$arLanguage["LID"]] ?? '') : ($arUserField["LIST_COLUMN_LABEL"][$arLanguage["LID"]] ?? ''))?>"></td>
					<td align="center"><input type="text" name="LIST_FILTER_LABEL[<?= $htmlLID?>]" size="20" maxlength="255" value="<?= htmlspecialcharsbx($bVarsFromForm? ($_REQUEST["LIST_FILTER_LABEL"][$arLanguage["LID"]] ?? '') : ($arUserField["LIST_FILTER_LABEL"][$arLanguage["LID"]] ?? ''))?>"></td>
					<td align="center"><input type="text" name="ERROR_MESSAGE[<?= $htmlLID?>]" size="20" maxlength="255" value="<?= htmlspecialcharsbx($bVarsFromForm? ($_REQUEST["ERROR_MESSAGE"][$arLanguage["LID"]] ?? '') : ($arUserField["ERROR_MESSAGE"][$arLanguage["LID"]] ?? ''))?>"></td>
					<td align="center"><input type="text" name="HELP_MESSAGE[<?= $htmlLID?>]" size="20" maxlength="255" value="<?= htmlspecialcharsbx($bVarsFromForm? ($_REQUEST["HELP_MESSAGE"][$arLanguage["LID"]] ?? '') : ($arUserField["HELP_MESSAGE"][$arLanguage["LID"]] ?? ''))?>"></td>
				</tr>
				<?php endwhile?>
			</table>
		</td>
