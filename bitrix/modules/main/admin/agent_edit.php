...
?>
	...
	<tr class="adm-detail-required-field">
		...
		<td width="60%"><?= CalendarDate("NEXT_EXEC", htmlspecialcharsbx($a_NEXT_EXEC), "f_agent", 20)?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="MODULE_ID" size="40" value="<?= $a_MODULE_ID?>"></td>
	</tr>
	<tr class="adm-detail-required-field">
		<td><?= GetMessage("MAIN_AGENT_NAME")?></td>
		<td><input type="text" name="NAME" size="40" value="<?= $a_NAME?>"></td>
	</tr>
	<tr>
		<td><?= GetMessage("MAIN_AGENT_USER_ID")?></td>
		<td><?= FindUserID("USER_ID", $a_USER_ID, "", "f_agent", 4)?>
	</tr>
	<tr>
		<td><?= GetMessage("MAIN_AGENT_SORT")?></td>
		<td><input type="text" name="SORT" size="40" value="<?= $a_SORT?>"></td>
	</tr>
	<tr>
		<td class="adm-detail-valign-top"><?= GetMessage("MAIN_AGENT_PERIODICAL1")?></td>
		<td>
			<label><input type="radio" name="IS_PERIOD" value="N"<?php if($a_IS_PERIOD<>"Y") echo " checked"?>><?= GetMessage("MAIN_AGENT_PERIODICAL_INTERVAL")?></label><br>
			<label><input type="radio" name="IS_PERIOD" value="Y"<?php if($a_IS_PERIOD=="Y") echo " checked"?>><?= GetMessage("MAIN_AGENT_PERIODICAL_TIME")?></label>
		</td>
	</tr>
	<tr>
		<td><?= GetMessage("MAIN_AGENT_INTERVAL")?></td>
		<td><input type="text" name="AGENT_INTERVAL" size="40" value="<?= $a_AGENT_INTERVAL?>"></td>
	</tr>
