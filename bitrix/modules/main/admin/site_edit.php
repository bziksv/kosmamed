...
?>
	<tr class="adm-detail-required-field">
		...
		<td width="60%"><?php
			if(!$bNew):
				echo $str_LID;
				?><input type="hidden" name="LID" value="<?= $str_LID?>"><?php
			else:
				?><input type="text" name="LID" size="2" maxlength="2" value="<?= $str_LID?>"><?php
			endif;
				?></td>
	</tr>
	<tr>
	...
	<tr class="adm-detail-required-field">
		...
		<td><input type="text" name="NAME" size="30" value="<?= $str_NAME?>"></td>
	</tr>
	<tr class="heading">
	...
	<tr>
		...
		<td><textarea name="DOMAINS" cols="40" rows="5"><?= $str_DOMAINS?></textarea>
		<?=BeginNote();?>
	...
	<tr class="adm-detail-required-field">
		...
		<td><input type="text" name="DIR" size="30" value="<?= $str_DIR?>"></td>
	</tr>
	<tr class="adm-detail-required-field">
		<td><?= GetMessage('SORT')?></td>
		<td><input type="text" name="SORT" size="10" value="<?= $str_SORT?>"></td>
	</tr>
	<tr>
		<td><?= GetMessage("MAIN_DOC_ROOT")?><br />
		<?= GetMessage("MAIN_DOC_ROOT_TIPS")?>
		</td>
		<td><input type="text" name="DOC_ROOT" size="30" value="<?= $str_DOC_ROOT?>">
	...
	<tr>
		...
		<td><input type="text" name="SITE_NAME" size="30" value="<?= $str_SITE_NAME?>"></td>
	</tr>
	<tr>
		<td><?= GetMessage("MAIN_SERVER_URL")?></td>
		<td><input type="text" name="SERVER_NAME" size="30" value="<?= $str_SERVER_NAME?>"></td>
	</tr>
	<tr>
		<td><?= GetMessage("MAIN_DEFAULT_EMAIL")?></td>
		<td><input type="text" name="EMAIL" size="30" value="<?= $str_EMAIL?>"></td>
	</tr>
