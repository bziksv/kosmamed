...
?>
	<tr>
		...
		<td><?php
			...
			if($ID>0 && $COPY_ID<=0)
			{
				...
				?><input type="hidden" name="EVENT_NAME" value="<?= $str_EVENT_NAME?>">[<a href="type_edit.php?EVENT_NAME=<?= $str_EVENT_NAME?>&amp;lang=<?= LANGUAGE_ID?>"><?= $str_EVENT_NAME?></a>] <?= $type_NAME?> <?php
			}
			else
			{
				$id_1st = false;
	...
	<tr class="adm-detail-required-field">
		...
		<td><input type="text" name="EMAIL_FROM" size="50" maxlength="255" value="<?= $str_EMAIL_FROM?>" onfocus="t=this">
		</td>
	</tr>
	<tr class="adm-detail-required-field">
		<td><?= GetMessage('MSG_EMAIL_TO')?></td>
		<td><input type="text" name="EMAIL_TO" size="50" maxlength="255" value="<?= $str_EMAIL_TO?>" onfocus="t=this"></td>
	</tr>
	...
	<tr id="msg_ext1" <?=$str_show_ext?>>
		...
		<td><input type="text" name="CC" size="50" maxlength="255" value="<?= $str_CC?>" onfocus="t=this">
		</td>
	</tr>

	<tr id="msg_ext2" <?=$str_show_ext?>>
		<td><?= GetMessage("MSG_BCC")?></td>
		<td><input type="text" name="BCC" size="50" value="<?= $str_BCC?>" onfocus="t=this">
		</td>
	</tr>

	<tr id="msg_ext3" <?=$str_show_ext?>>
		<td><?= GetMessage("MSG_REPLY_TO")?></td>
		<td><input type="text" name="REPLY_TO" size="50" maxlength="255" value="<?= $str_REPLY_TO?>" onfocus="t=this">
		</td>
	</tr>

	<tr id="msg_ext4" <?=$str_show_ext?>>
		<td><?= GetMessage("MSG_IN_REPLY_TO")?></td>
		<td><input type="text" name="IN_REPLY_TO" size="50" maxlength="255" value="<?= $str_IN_REPLY_TO?>" onfocus="t=this">
		</td>
	</tr>
	...
	<tr id="msg_ext5" <?=$str_show_ext?>>
		...
		<td>
		<input type="text" name="PRIORITY" id="MSG_PRIORITY" size="10" maxlength="255" value="<?= $str_PRIORITY?>" onfocus="t=this">
		<select onchange="document.getElementById('MSG_PRIORITY').value=this.value">
			<option value=""></option>
			<option value="1 (Highest)"<?php if($str_PRIORITY=='1 (Highest)')echo ' selected'?>><?= GetMessage("MSG_PRIORITY_1")?></option>
			<option value="3 (Normal)"<?php if($str_PRIORITY=='3 (Normal)')echo ' selected'?>><?= GetMessage("MSG_PRIORITY_3")?></option>
			<option value="5 (Lowest)"<?php if($str_PRIORITY=='5 (Lowest)')echo ' selected'?>><?= GetMessage("MSG_PRIORITY_5")?></option>
		</select>
		</td>
	</tr>
	...
	<?php foreach($arADDITIONAL_FIELD as $additionalField):?>
		<tr id="msg_ext<?=++$msg_ext?>" <?=$str_show_ext?>>
			<td>
				<input type="text" name="ADDITIONAL_FIELD[NAME][]" size="20" maxlength="255" value="<?= htmlspecialcharsbx($additionalField['NAME'])?>" onfocus="t=this">:
			</td>
			<td>
				<input type="text" name="ADDITIONAL_FIELD[VALUE][]" size="55" maxlength="255" value="<?= htmlspecialcharsbx($additionalField['VALUE'])?>" onfocus="t=this">
			</td>
		</tr>
	<?php endforeach;?>
	...
	<tr>
		...
		<td><input type="text" name="SUBJECT" size="50" maxlength="255" value="<?= $str_SUBJECT?>" onfocus="t=this"></td>
	</tr>
	<tr class="heading">
