...
<tr>
	...
	<td><input type="text" name="find_user_id" size="47" value="<?= htmlspecialcharsbx($find_user_id)?>"></td>
</tr>
<tr>
...
<tr>
	...
	<td><?= CAdminCalendar::CalendarPeriod("find_date_insert_1", "find_date_insert_2", $find_date_insert_1, $find_date_insert_2, false, 15, true)?></td>
</tr>
<tr>
	<td><?= $arFilterNames["find_remote_addr"]?>:</td>
	<td><input type="text" name="find_remote_addr" size="47" value="<?= htmlspecialcharsbx($find_remote_addr)?>"></td>
</tr>
<tr>
	<td><?= $arFilterNames["find_user_agent"]?>:</td>
	<td><input type="text" name="find_user_agent" size="47" value="<?= htmlspecialcharsbx($find_user_agent)?>"></td>
</tr>
<tr>
	<td><?= $arFilterNames["find_request_uri"]?>:</td>
	<td><input type="text" name="find_request_uri" size="47" value="<?= htmlspecialcharsbx($find_request_uri)?>"></td>
</tr>
<tr>
	<td><?= $arFilterNames["find_field"]?>:</td>
	<td><input type="text" name="find_field" size="47" value="<?= htmlspecialcharsbx($find_field)?>"></td>
</tr>
<?php
