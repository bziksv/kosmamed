...
$MESS["ARTURGOLUBEV_CHATGPT_OPTION_ALG_IMAGE_MODEL_D2"] = "DALL-E 2 (первое поколение, базовая)";
$MESS["ARTURGOLUBEV_CHATGPT_OPTION_ALG_IMAGE_MODEL_D3"] = "DALL-E 3 (второе поколение)";
$MESS["ARTURGOLUBEV_CHATGPT_OPTION_ALG_IMAGE_MODEL_I1"] = "GPT Image 1 (актуальная)";
...
$MESS["ARTURGOLUBEV_CHATGPT_MODEL_GPT_4_1"] = "gpt-4.1 (предыдущее поколение)";
$MESS["ARTURGOLUBEV_CHATGPT_MODEL_O3_MINI"] = "o3 mini (рассуждающая)";
$MESS["ARTURGOLUBEV_CHATGPT_MODEL_O4_MINI"] = "o4 mini (рассуждающая, актуальная)";

$MESS["ARTURGOLUBEV_CHATGPT_MODEL_GPT_5_0"] = "gpt-5 (актуальная, полная версия)";
$MESS["ARTURGOLUBEV_CHATGPT_MODEL_GPT_5_MINI"] = "gpt-5-mini (актуальная, рекомендуемая, быстрая и экономичная)";
$MESS["ARTURGOLUBEV_CHATGPT_MODEL_GPT_5_NANO"] = "gpt-5-nano (актуальная, максимально быстрая и экономичная)";
...
$MESS["ARTURGOLUBEV_CHATGPT_MODEL_DS_deepseek-chat"] = "deepseek-chat (рекомендуемая)";
$MESS["ARTURGOLUBEV_CHATGPT_MODEL_DS_deepseek-reasoner"] = "deepseek-reasoner (для сложных рассуждений)";
