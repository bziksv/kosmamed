<?if(!defined("ELEKTROINSTRUMENT_MODULE_ID")) define("ELEKTROINSTRUMENT_MODULE_ID", "prime.elektroinstrument");
...
class CElektroinstrument {
	...
	static public function GetBackParametrsValues($SITE_ID, $bStatic = true){
		if($bStatic){
			static $arValues;
		}
	...
	static public function GetFrontParametrsValues($SITE_ID){
	...
	static public function CheckColor($strColor) {
	...
	static public function UpdateParametrsValues() {
	...
	static public function GenerateColorScheme() {
		$arBackParametrs = self::GetBackParametrsValues(SITE_ID);
	...
	static public function DeleteEventTypeEventMessage(&$arFields) {
	...
	static public function DoIBlockAfterSave($arg1, $arg2 = false) {
		$elementId = false;
		$iblockId = false;
	...
	static public function SetOrderPropertiesLocation(&$arUserResult, $request, &$arParams, &$arResult) {
