...
<?=bitrix_sessid_post()?>
	...
	<input type="hidden" name="id" value="askaron.clientid">
	...
	<p><input type="checkbox" name="savedata" id="savedata" value="Y" checked><label for="savedata"><?echo GetMessage("ASKARON_CLIENTID_SAVE_TABLES_AND_PEOPERTIES")?></label></p>
