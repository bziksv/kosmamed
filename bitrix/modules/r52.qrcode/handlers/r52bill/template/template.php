...
$original_order_id = $_REQUES['ORDER_ID'];
...
<?if ($params['BILL_HEADER_SHOW'] == 'Y'):?>
	<table class="header 78" style="width: 100%; margin-bottom: 10px;"">
		<tr style="d">
            <td style="text-align: center; width: 100%" colspan="2">
<b>Если Вы физическое/юридическое лицо, и оплачиваете с банка в РФ, самый простой способ оплата по QR-коду</b><br><br>							
            </td>
...
?>
<table class="it zzzzzz" width="100%">
	<tr>
...
<div class="only_print 1"></div>
<div class="only_print 2"></div>
...
<?if($_REQUEST['print'] != 'y'):?>
<?if($_REQUEST['PAYMENT_ID']):?>
	<a class="bill_print" href="?PAYMENT_ID=<?=$_REQUEST['PAYMENT_ID']?>&ORDER_ID=<?=$_REQUEST['ORDER_ID']?>&print=y">напечатать счет</a>
<div style="clear: both;"></div>
<?else:?>
	<a class="bill_print" href="/personal/order/make/?ORDER_ID=<?=$_REQUEST['ORDER_ID']?>&print=y">напечатать счет</a>
	<div style="clear: both;"></div>
<?endif;?>
<?endif;?>
</body>
