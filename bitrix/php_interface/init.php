<?
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/bitrix/php_interface/include/km_catalog_gate.php')){
   require_once($_SERVER['DOCUMENT_ROOT'].'/bitrix/php_interface/include/km_catalog_gate.php');
}
