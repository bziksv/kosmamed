...
<?php
/* Информационное сообщение в корзине*/
/*
echo'
<div style="border: 2px solid #d4a017; background-color: #fffdf6; padding: 20px; margin: 15px 0; border-radius: 8px; font-family: Arial, sans-serif; color: #333;"> <h3 style="color: #b8860b; margin-top: 0; display: flex; align-items: center;"> <svg style="margin-right: 10px;" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM13 17H11V15H13V17ZM13 13H11V7H13V13Z" fill="#b8860b"/> </svg> Важная информация </h3> <p style="margin-bottom: 0; line-height: 1.5;"> <strong>Магазин работает на текущий момент только с <span style="color: #b8860b;">юридическими лицами</span>.</strong><br> О возобновлении работы с физическими лицами мы уведомим по электронной почте, которую Вы указали при регистрации. </p> </div>
';
*/
?>
<?php
