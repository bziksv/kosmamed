						...
						<td>
							<?switch($key_field) {
								...
								case "PREVIEW_PICTURE":								
									...
									<?} else {?>
										<a href="<?=$arElement['DETAIL_PAGE_URL']?>">
											<img src="<?=SITE_TEMPLATE_PATH?>/images/no-photo.svg" width="150" height="150" alt="<?=$arElement["NAME"]?>" title="<?=$arElement["NAME"]?>" />
										</a>
									<?}
								break;								
								//COMPARE_FIELD//
			...
			if((isset($arElement["OFFERS"]) && !empty($arElement["OFFERS"])) || $arElement["SELECT_PROPS"]) {				
				...
				$arJSParams = array(					
					...
					"PRODUCT" => array(
						"ID" => $arElement["ID"],
						"NAME" => $arElement["NAME"],
						"PICT" => is_array($arElement["FIELDS"]["PREVIEW_PICTURE"]) ? $arElement["FIELDS"]["PREVIEW_PICTURE"] : array("SRC" => SITE_TEMPLATE_PATH."/images/no-photo.svg", "WIDTH" => 150, "HEIGHT" => 150),
