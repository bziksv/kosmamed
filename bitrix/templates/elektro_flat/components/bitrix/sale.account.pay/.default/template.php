								...
								<div class="sale-acountpay-pp-company-graf-container">
									<div class="sale-acountpay-pp-company-graf">
										...
										<div class="sale-acountpay-pp-company-image">
											<img src="<?=(isset($paySystem['LOGOTIP']) && !empty($paySystem['LOGOTIP']) ? $paySystem['LOGOTIP'] : SITE_TEMPLATE_PATH.'/images/no-photo.svg');?>" alt="<?=$paySystem['NAME']?>" title="<?=$paySystem['NAME']?>" />
										</div>										
