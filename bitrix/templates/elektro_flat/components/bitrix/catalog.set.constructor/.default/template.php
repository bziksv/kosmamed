				...
				<div class="item-image-cont">
					<div class="item-image">					
						<span>
							...
							<?else:?>
								<img class="item_img" src="<?=SITE_TEMPLATE_PATH?>/images/no-photo.svg" width="150" height="150" alt="<?=$arResult['ELEMENT']['NAME']?>" />
							<?endif?>
						</span>							
					</div>
				</div>
						...
						<div class="catalog-item-image-cont">
							<div class="catalog-item-image">
								<a href="<?=$arItem['DETAIL_PAGE_URL']?>">
									...
									<?else:?>
										<img class="item_img" src="<?=SITE_TEMPLATE_PATH?>/images/no-photo.svg" width="150" height="150" alt="<?=$arItem['NAME']?>" />
									<?endif;?>
								</a>							
							</div>
						</div>
...
<?$arJsParams = array(		
	...
	"mainElementPict" => is_array($arResult["ELEMENT"]["PREVIEW_PICTURE"]) ? $arResult["ELEMENT"]["PREVIEW_PICTURE"] : array("SRC" => SITE_TEMPLATE_PATH."/images/no-photo.svg", "WIDTH" => 150, "HEIGHT" => 150),
	...
	"noFotoSrc" => SITE_TEMPLATE_PATH."/images/no-photo.svg",
	"messages" => array(		
