		...
		<div class="equipment" id="cart_equipment">
			<div class="thead">
				...
				<?if(in_array("DISCOUNT", $arParams["COLUMNS_LIST"])):?>
					<div class="cart-item-summa cart-item-summa_1"><?=GetMessage("SALE_DISCOUNT")?></div>
				<?endif;?>
				...
				<?endif;?>
				<div class="cart-item-summa cart-item-summa_2"><?=GetMessage("SALE_SUMMA")?></div>
				...
				foreach($arResult["ITEMS"]["AnDelCanBuy"] as $arBasketItems) {?>
					<div class="tr" id="<?=$arBasketItems['ID']?>">
						<div class="tr_into">
							...
							<?endif;?>
							<?if(in_array("DISCOUNT", $arParams["COLUMNS_LIST"])): ?>
							<div class="cart-item-summa cart-item-summa_4">
								<span class="sum">
									<span><?=$arBasketItems["DISCOUNT_PRICE_PERCENT_FORMATED"]?></span>
								</span>
							</div>
							<?endif;?>
							<?if(in_array("PRICE", $arParams["COLUMNS_LIST"])):?>
							...
							<?endif;?>
<?if($arBasketItems["AVAILABLE_QUANTITY"]):?>
	<div class="available only_mob">
		<div class="avl">
			<i class="fa fa-check-circle"></i>
			<span>
				В наличии  <?=$arBasketItems["AVAILABLE_QUANTITY"]?>
			</span>
		</div>
	</div>
<?endif;?>
