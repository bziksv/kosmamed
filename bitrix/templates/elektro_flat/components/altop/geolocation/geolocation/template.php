...
if($arParams["USE_GEOLOCATION"] == "Y"):?>
	<?/*<div id="geolocation" class="geolocation">
		<a id="geolocationChangeCity" class="geolocation__link" href="javascript:void(0);"><i class="fa fa-map-marker" aria-hidden="true"></i>
<span class="geolocation__value"><?=(!empty($arParams["GEOLOCATION_CITY"]) ? $arParams["GEOLOCATION_CITY"] : Loc::getMessage("GEOLOCATION_POSITIONING"));?></span></a>
	</div>
	*/?>
<?
$arClear1 = explode('<span>', $arResult["CONTACTS"]);

$arClear = str_replace("</span>", "", $arClear1[1]);
$arClear = str_replace("</p>", "", $arClear);
?>
	<a href="tel:<?=$arClear?>" class="telephone"><?=(!empty($arResult["CONTACTS"]) ? $arResult["CONTACTS"] : "");?></a>
...
<?else:?>
	<a class="telephone"><?=(!empty($arResult["CONTACTS"]) ? $arResult["CONTACTS"] : "");?></a>
<?endif;
