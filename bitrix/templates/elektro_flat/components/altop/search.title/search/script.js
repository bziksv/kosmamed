...
var action = $('input[name=action_'+elementId+']').val();
var str_main_id = 'under_order_'+visualId;
var name = $('input[name=name_'+elementId+']').val();
		BX.PropsSet =
		{			
			popup: null
		};
	...
	$('.popup-window.more_options').addClass('forms');
	$('.popup-window.more_options').addClass('full');
	$('.popup-window.more_options').addClass('more_options');
