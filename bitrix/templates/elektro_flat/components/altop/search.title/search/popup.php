...
$arParams2 = str_replace("'", '"', $arParams);

$arParams = json_decode($arParams2, true); 

$arParams['CACHE_TYPE'] = 'N';

		$arParams["ELEMENT_ID"] = $request->getPost("ELEMENT_ID");
		$arParams["ELEMENT_AREA_ID"] = $request->getPost("STR_MAIN_ID2");
		$arParams["STR_MAIN_ID"] = $request->getPost("STR_MAIN_ID");
		$arParams["ELEMENT_NAME"] = $request->getPost("ELEMENT_NAME");
			...
			<div style="display: none" class="popup-window-titlebar" id="popup-window-titlebar-under_order_<?=$arParams["STR_MAIN_ID"]?>">Заказать товар</div>
...
$arUnderOrderFilter = array(
				"ELEMENT_ID" => 85585,
				"ELEMENT_AREA_ID" => 'under_order_bx_117848907_85585',
				"ELEMENT_NAME" => 'Микротом санный МС-1 полуавтоматический, полная комплектация'
			);
*/



		$arParams2["ELEMENT_ID"] = $request->getPost("ELEMENT_ID");
		$arParams2["ELEMENT_AREA_ID"] = $request->getPost("STR_MAIN_ID2");

			// $elementId = $request->getPost("ELEMENT_ID");
			// $strMainId = $request->getPost("STR_MAIN_ID2");
?>
...
// 		"IBLOCK_TYPE" => "forms",
// 		"IBLOCK_ID" => "2",
// 		"ELEMENT_ID" => $arParams2["ELEMENT_ID"],
// 		"ELEMENT_AREA_ID" => $arParams2["ELEMENT_AREA_ID"],
// 		"ELEMENT_NAME" => $arParams2["ELEMENT_NAME"],
// 		"ELEMENT_PRICE" => "",		
// 		"CACHE_TYPE" => "N",
// 		"CACHE_TIME" => "36000000"
// 	),
...
$APPLICATION->IncludeComponent("bitrix:catalog.element", "props2",
				array(
