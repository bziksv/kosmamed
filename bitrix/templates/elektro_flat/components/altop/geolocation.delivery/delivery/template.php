...
<div id="geolocationDelivery-<?=$arParams['ELEMENT_ID']?>" class="geolocation-delivery" data-element-id="<?=$arParams['ELEMENT_ID']?>" data-element-count="<?=$arParams['ELEMENT_COUNT']?>" data-cart-products="<?=$arParams['CART_PRODUCTS']?>" data-cache-type="<?=$arParams['CACHE_TYPE']?>" data-cache-time="<?=$arParams['CACHE_TIME']?>" data-component-template="delivery">
	...
	<?elseif($arParams["AJAX_CALL"] != "Y"):?>
		<div class="geolocation-delivery__delivery-list">
			<div class="geolocation-delivery__delivery-item">
				<span class="geolocation-delivery__delivery-name">
					<?$APPLICATION->IncludeComponent(
						"bitrix:main.include",
						"",
						Array(
							"AREA_FILE_SHOW" => "file",
							"AREA_FILE_SUFFIX" => "/include/product_delivery.php",
							"COMPOSITE_FRAME_MODE" => "A",
							"COMPOSITE_FRAME_TYPE" => "AUTO",
							"EDIT_TEMPLATE" => "",
							"PATH" => "/include/product_delivery.php"
						)
					);?>
				</span>
			</div>
...
<script type="text/javascript">		
	...
	<?elseif($arParams["AJAX_CALL"] != "Y" && $arParams["GEOLOCATION_LOCATION_ID"] > 0):?>
		//SHOW_GEOLOCATION_DELIVERY//
		BX.ready(function() {
			if(typeof BX.ShowGeolocationDelivery === "function")
