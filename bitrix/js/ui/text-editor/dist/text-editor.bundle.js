...
(function (exports,ui_codeParser,ui_bbcode_parser,ui_textEditor,ui_lexical_clipboard,ui_smiley,ui_videoService,main_core_collections,ui_bbcode_model,ui_lexical_selection,ui_lexical_richText,ui_lexical_table,main_core_events,ui_lexical_html,ui_lexical_history,ui_iconSet_api_core,main_popup,main_core_cache,ui_lexical_list,ui_lexical_link,ui_lexical_text,ui_lexical_core,ui_lexical_utils,main_core) {
	...
	*/
	...
	var _isHtmlResponseFormat = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("isHtmlResponseFormat");
	var _createNodesFromHtml = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("createNodesFromHtml");
	class CopilotPlugin extends BasePlugin {
	  constructor(editor) {
	    super(editor);
	    Object.defineProperty(this, _createNodesFromHtml, {
	      value: _createNodesFromHtml2
	    });
	    Object.defineProperty(this, _isHtmlResponseFormat, {
	      value: _isHtmlResponseFormat2
	    });
	...
	function _handleCopilotSave2(event) {
	  ...
	  this.getEditor().update(() => {
	    ...
	    const selection = ui_lexical_core.$getSelection();
	    if (ui_lexical_core.$isRangeSelection(selection)) {
	      if (babelHelpers.classPrivateFieldLooseBase(this, _isHtmlResponseFormat)[_isHtmlResponseFormat]()) {
	        selection.removeText();
	        const nodes = babelHelpers.classPrivateFieldLooseBase(this, _createNodesFromHtml)[_createNodesFromHtml](result);
	...
	function _isHtmlResponseFormat2() {
	  var _babelHelpers$classPr;
	  return ((_babelHelpers$classPr = babelHelpers.classPrivateFieldLooseBase(this, _copilotOptions)[_copilotOptions]) == null ? void 0 : _babelHelpers$classPr.responseFormat) === 'html';
	}
	function _createNodesFromHtml2(html) {
...
}((this.BX.UI.TextEditor = this.BX.UI.TextEditor || {}),BX.UI.CodeParser,BX.UI.BBCode,BX.UI.TextEditor,BX.UI.Lexical.Clipboard,BX.UI.Smiley,BX.UI.VideoService,BX.Collections,BX.UI.BBCode,BX.UI.Lexical.Selection,BX.UI.Lexical.RichText,BX.UI.Lexical.Table,BX.Event,BX.UI.Lexical.Html,BX.UI.Lexical.History,BX.UI.IconSet,BX.Main,BX.Cache,BX.UI.Lexical.List,BX.UI.Lexical.Link,BX.UI.Lexical.Text,BX.UI.Lexical.Core,BX.UI.Lexical.Utils,BX));
