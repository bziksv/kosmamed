...
(function (exports,ui_fonts_opensans,sidepanel,main_core,main_core_events,ui_buttons,ui_sidepanel_menu) {
	...
	class Layout {
	  ...
	  render(content = '', promised = false) {
	    ...
	    if (babelHelpers.classPrivateFieldLooseBase(this, _options)[_options].title) {
	      ...
	      const hint = babelHelpers.classPrivateFieldLooseBase(this, _options)[_options].hint ? main_core.Tag.render(_t4 || (_t4 = _`
					<span class="ui-hint" data-hint="${0}">
						<span class="ui-hint-icon"/>
					</span>
				`), babelHelpers.classPrivateFieldLooseBase(this, _options)[_options].hint) : '';
	      const header = main_core.Tag.render(_t5 || (_t5 = _`
	      ...
	      if (main_core.Type.isFunction(babelHelpers.classPrivateFieldLooseBase(this, _options)[_options].toolbar)) {
	        const toolbar = main_core.Tag.render(_t6 || (_t6 = _`<div class="ui-sidepanel-layout-toolbar"></div>`));
	    ...
	    // CONTENT
	    {
	      ...
	      let contentElement = main_core.Tag.render(_t7 || (_t7 = _`<div class="${0}" style="${0}"></div>`), classes.join(' '), styles.join('; '));
	      ...
	      main_core.Dom.append(main_core.Tag.render(_t8 || (_t8 = _`<div class="ui-sidepanel-layout-content-inner"></div>`)), contentElement);
	      contentElement = contentElement.lastElementChild;
	      if (design.section) {
	        main_core.Dom.append(main_core.Tag.render(_t9 || (_t9 = _`<div class="ui-slider-section ui-sidepanel-layout-content-fill-height"></div>`)), contentElement);
	    ...
	    if (main_core.Type.isFunction(babelHelpers.classPrivateFieldLooseBase(this, _options)[_options].buttons) || isButtonsUndefined) {
	      ...
	      if (buttonList && buttonList.length > 0) {
	        main_core.Dom.append(main_core.Tag.render(_t10 || (_t10 = _`<div class="ui-sidepanel-layout-footer-anchor"></div>`)), container);
	        ...
	        const buttons = main_core.Tag.render(_t11 || (_t11 = _`<div class="${0}"></div>`), classes.join(' '));
	...
	function _getScrollWidth2() {
	  const div = main_core.Tag.render(_t12 || (_t12 = _`<div style="overflow-y: scroll; width: 50px; height: 50px; opacity: 0; pointer-events: none; position: absolute;"></div>`));
