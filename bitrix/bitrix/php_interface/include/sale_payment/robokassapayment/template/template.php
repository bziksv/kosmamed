...
<form action="<?=$params['URL']?>" method="post">
	...
	<input type="hidden" name="InvId" value="<?=((int)$params['PAYMENT_ID'] + $params['IPOL_ROBOKASSA_OPTIONS_TAB_PAYMENT_ID_MODIFICATION_COUNT']);?>">
