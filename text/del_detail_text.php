...
require($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/main/include/prolog_before.php");
    ...
    if (CModule::IncludeModule("iblock")) {
        ...
        $descriptionFieldCode = "DETAIL_TEXT"; // здесь указываем символьный код свойства описания товара
        $emptyDescriptionValue = ""; // здесь указываем значение, которое нужно присвоить свойству описания товара

        $dbItems = CIBlockElement::GetList(
            [],
            ["IBLOCK_ID" => $iblockId, "!DETAIL_TEXT" => false],
            false,
        ...
        if(count($arEtamId)>0){
            LocalRedirect("/text/del_detail_text.php");
        }
