...
$options = [
	...
	'DOMAINS' => [
		'kosmamed.ru' => 'kosmamed.ru',
		'www.kosmamed.ru' => 'www.kosmamed.ru',
	],
	'IGNORED_PARAMETERS' =>
...
echo "Next: bash tools/perf/prod-warmup.sh https://kosmamed.ru\n";
echo "Check: bash tools/perf/prod-composite-check.sh https://kosmamed.ru\n";
